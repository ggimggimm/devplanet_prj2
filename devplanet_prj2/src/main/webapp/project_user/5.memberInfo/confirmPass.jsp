...
<div id="header">
	<div class="gnbWrap gnbWrap_mMng">
		...
		<div id="gnb">
			...
			<span class="bar"><span class="title"><img src="http://localhost/devplanet_prj2/project_admin/images/h_mng_gg.gif" width="117" height="23" alt="회원정보 관리"></span></span>
			</h1>
<!--skip은 안보임  -->	<h2 class="skip"><!--주요링크--></h2>
			...
			<div class="secNav">
				<ol>
					<li class="mn1"><a href="http://localhost/devplanet_prj2/project_user/5.memberInfo/confrimInfo.jsp"><span></span>개인정보 수정</a></li>
					<li class="mn2"><a href="http://localhost/devplanet_prj2/project_user/5.memberInfo/confirmPass.jsp"><span class="span"></span>비밀번호변경</a></li>
					<li class="mn3 end"><a href="http://localhost/devplanet_prj2/project_user/5.memberInfo/quit_member.jsp" target="_blank"><span></span>회원탈퇴</a></li>
...
<!--skip은 안보임  -->	<legend><!-- 비밀번호 변경 정보 입력폼 --></legend>
				<div class="mbrSec mbrMngPWD">
					<h2 class="mbrHeading2"><img src="http://localhost/devplanet_prj2/project_admin/images/mbr_h_mng_pwdchange.gif" alt="비밀번호 변경"></h2>
