...
<!--skip은 안보임  -->	<h2 class="skip"><!--주요링크--></h2>
			<ul class="lnb">
				<li><a href="http://localhost/devplanet_prj2/project_user/1.main/main_page.jsp">개인회원 홈</a></li>
			</ul>
			<!-- <br><br><br> -->
			<div class="secNav">
				<ol>
...
<div id="wrap">
	...
	<div id="container">
		<div id="content">
			<form id="con_frm" name="con_frm" method="post" action="http://localhost/devplanet_prj2/project_user/5.memberInfo/quit_member_process.jsp">
