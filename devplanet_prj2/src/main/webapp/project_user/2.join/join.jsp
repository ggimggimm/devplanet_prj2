...
<title>DEVPLANET-회원가입</title>
    ...
    <link href="http://localhost/devplanet_prj2/project_user/2.join/css/" rel="stylesheet" type="text/css" />
    <link href="http://localhost/devplanet_prj2/project_user/2.join/css/common-sv-202006161246.css" rel="stylesheet" type="text/css" />
    <link href="http://localhost/devplanet_prj2/project_user/2.join/css/join-sv-202203141106.css" rel="stylesheet" type="text/css" />
...
$(function() {	
	...
	$("#idDup").click(function() {
		window.open("id_dup.jsp","subWin","width=520, height=320,top="+(window.screenY+100)+", left="+(window.screenX+100));
	});
	
	$("#lb_chk_all").click(function() {
		if( $("#lb_chk_all").is(":checked") ) {
			$("#lb_chk_age").prop('checked',true);
			$("#lb_chk_service").prop('checked',true);
			$("#lb_chk_privacy").prop('checked',true);
			$("#lb_chk_privacyOptional").prop('checked',true);
		}else {
			$("#lb_chk_age").prop('checked',false);
			$("#lb_chk_service").prop('checked',false);
			$("#lb_chk_privacy").prop('checked',false);
			$("#lb_chk_privacyOptional").prop('checked',false);
		}//end else
		
	})//lb_chk_all
	
	$("#lb_chk_privacyOptional").change(function() {
	    if ($("#lb_chk_privacyOptional").is(':checked')) {
	        $("#lb_chk_privacyOptional").val('Y');
	        console.log("if : "+$("#lb_chk_privacyOptional").val());
	    }
	});
});// ready
	...
	$("#btnTest").on(function () {
		 ...
		 if ($("#lb_chk_privacyOptional").is(':checked')) {
			 ...
			 console.log("if : "+$("#lb_chk_privacyOptional").val());
				  ...
				  console.log("else : "+$("#lb_chk_privacyOptional").val());
			  }//end else
...
<body class="jkJoin">
	<div id="wrap">
		...
		<div id="header">
			<div class="joinTop">
				<h2>
					<span class="slogun_1">JOBKOREA</span>
				</h2>
			</div>

			<h3 class="skip">글로벌 메뉴</h3>
			<ul class="gnb f_clear">
				<li><a href="http://localhost/devplanet_prj2/project_user/1.main/main_page.jsp">홈</a></li>
			</ul>
		...
		<div id="container" class="mbrRegist">
			...
			<fieldset>
				...
				<form action="completeJoin.jsp" name="joinFrm" id="joinFrm" method="post">
					<!-- 약관 동의 -->
					<input data-val="true"
					...
					<div class="row_group mbr_info">
						...
						<div class="row mbr_name">
							...
							<div class="col_2">
								<input type="text" id="name" name="name" placeholder="이름(실명)" class="mbr_name devReadOnly dev-name" maxlength="12">
						...
						<div class="row mbr_id">
							...
							<div class="col_id">
								<input type="text" id="userId" name="userId" placeholder="아이디" readonly="readonly" maxlength="16" class="dev-id" value="" style="ime-mode: disabled;">
								<div class="btn">
						...
						<div class="row mbr_passwd">
							...
							<!-- <div class="col_3">
								<input type="checkbox" class="mbrBtnAuth dev-password-dp" value="표시"/><span></span>
						...
						<div class="row mbr_phone">
							<div class="col_1">
								<i class="icon required" aria-hidden="hidde">*</i></label>
							</div>
							<div class="col_2">
						...
						<div class="row mbr_zipcode">
							...
							<div class="col_zipcode">
								<input type="text" id="zipcode" readonly="readonly" name="zipcode" placeholder="우편번호">
								<div class="btn">
									<button type="button" class="btnSend" id="kakao">
										<span>주소검색</span>
									</button>
								</div>
							</div>
					...
					<div class="row_group line_all policy">
						<div class="row policy_check_all">
							<input type="checkbox" id="lb_chk_all" name="allTerms" value="0" class="mbrCheckOff" onclick="check()">
						...
						<div class="row policy_check_service required">
							<input type="checkbox" id="lb_chk_age" name=""
								class="mbrCheckOn" value="1"> <label for="lb_chk_age"
								class="chk_age"><strong>[필수]</strong> 만 15세 이상입니다 </label>
						</div>
						<div class="row policy_check_service required">
							<input type="checkbox" id="lb_chk_service" name=""
								class="mbrCheckOn" value="2"> <label
						...
						<div class="row policy_check_privacy required">
							<input type="checkbox" id="lb_chk_privacy" name=""
								class="mbrCheckOn" value="3"> <label
						...
						<div class="row policy_check_privacyOptional optional">
							<input type="checkbox" id="lb_chk_privacyOptional"
								name="terms" class="mbrCheckOn" value="N">
					...
					<div class="row_group line_none regist_complete" style="position: relative;">
						<div class="row">
							<input type="button" value="가입하기" id="join" class="mbrBtnRegist" style="border: none;">
						</div>
					</div>
				</form>
			</fieldset>
		...
		<div id="footer">
			<p id="copyright">
			© DEVPLANET LLC. All rights reserved.
			</p>
			<map name="copyright">
