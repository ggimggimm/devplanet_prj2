...
<div id="header">
	<div class="gnbWrap gnbWrap_mSearch">
		<div class="globalBar globalBarSub" id="globalBar">
			<div class="innerBar">
				<ul class="lnb">
					<li class="mn highlight"><a href="http://localhost/devplanet_prj2/project_user/2.join/login.jsp">로그인</a></li>
					<li class="mn"><a href="http://localhost/devplanet_prj2/project_user/2.join/join.jsp">회원가입</a></li>
				</ul>
			</div>
		</div>
		<div id="gnb">
			<h1><a class="logo" href="http://localhost/devplanet_prj2/project_user/1.main/main_page.jsp"><img alt="데브플래닛" src="http://localhost/devplanet_prj2/project_user/3.idPass/images/devplanet_logo_id_white.png"></a>
			<span class="bar">
				<span class="title">
					<img src="http://localhost/devplanet_prj2/project_user/3.idPass/images/h_cc_schid.gif" alt="아이디 찾기">
				</span>
			</span>
			</h1>
			<div class="secNav">
	...
	<div id="container">
		<div id="content">
			...
			<div class="mbrSec mbrSchIDResult">
				<h2 class="mbrHeading2"><img src="http://localhost/devplanet_prj2/project_user/3.idPass/images/mbr_h_msch_id_2.gif" alt="아이디조회"></h2>
				...
				<p class="mbrBtnFunc"><span class="mbrBtn mbrBtnLogin_1"><a href="http://localhost/devplanet_prj2/project_user/2.join/login.jsp">로그인</a></span> <span class="mbrBtn mbrBtnSearch_2"><a href="http://localhost/devplanet_prj2/project_user/3.idPass/findPw.jsp">비밀번호 찾기</a></span></p>
			</div>
			<hr>
		</div>
		<hr>
