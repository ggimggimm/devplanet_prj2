        ...
        <article class="artReadJobSum">
            ...
            <br/><br/>
                    ...
                    <div class="tbLogo">
                        <div class="logo">
                            <p>
                                <img src="http://localhost/devplanet_prj2/upload/${ job.logo }" id="cologo" name="cologo" alt="${ job.cName }" onload="go_logo_size(this, 100, 40);" />
                            </p>
                        </div>
                    </div>
...
<div id="detail">
<img src="http://localhost/devplanet_prj2/upload/${ job.description }"/>
</div>
<!-- 상세요강 끝 -->
<!-- 마감 -->
<div id="end">
