...
<div id="wrap">
	<div id="header">
		<div id="innerBar">
			<p><a style="color: #f1f1f1" href="http://localhost/devplanet_prj2/project_admin/1.mainAdmin/main.jsp">메인 페이지</a></p>
		</div>
		<div id="titlee">
			<h1>DEVPLANET </h1> 
...
%>
		...
		<form action="http://localhost/devplanet_prj2/project_admin/5.recruitAd/recruitmod_process.jsp" name="recruitAdMod" id="recruitAdMod" method="post"
		...
		<div id="detail">
			...
			<input type="hidden" class="contxtR" id="descriptionHidden" readonly="readonly" name="descriptionHidden" value="<c:out value="${mVO.description}"/>"/>
			 ...
			 <div id="previewDiv">
			 	<img id="preview" src="http://localhost/devplanet_prj2/upload/${mVO.description}">
			 </div>
		</div>
