...
$(function() {
	...
	$("#refreshBtn").click(function(){
		//history.back();		
		location.href="http://localhost/devplanet_prj2/project_admin/3.recruitAdmin/job_posting.jsp";
...
<div class="search">
<form action="http://localhost/devplanet_prj2/project_admin/3.recruitAdmin/total_applicant.jsp" name="searchPeople" id="searchPeople">
...
<tr class="hover">
   ...
   <%-- <td><a href="http://localhost/devplanet_prj2/project_admin/4.resumeView/resumeView.jsp?id=${aVO.id}&rNum=${aVO.rNum}&applyNum=${aVO.applyNum}"> --%>
   <td><a href="http://localhost/devplanet_prj2/project_admin/4.resumeView/resumeView.jsp?jobNum=<%=jobNum%>&id=${aVO.id}&rNum=${aVO.rNum}&applyNum=${aVO.applyNum}">
